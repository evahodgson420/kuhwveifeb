        ...
        return new ContainerBuilder()
            ...
            .addSectionComponents(
                new SectionBuilder()
                    .addTextDisplayComponents(
                        new TextDisplayBuilder().setContent(
                            emojis.withEmoji('panelTerms', 'Before getting started, we recommend reviewing our [Exchange Terms](https://orbittrade.org/tos) and [Guidelines](https://discord.com/channels/1474834585626870021/1474837358619922443) to ensure everything runs smoothly and securely.'),
                        ),
                    )
                    .setButtonAccessory(
                        new ButtonBuilder()
