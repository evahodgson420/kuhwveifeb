...
const CURRENCY_OPTIONS = [
    ...
    { label: 'GBP (£)', value: 'gbp', description: 'British Pound', emoji: emojis.getComponent('currencyOption') },
    { label: 'INR (₹)', value: 'inr', description: 'Indian Rupee', emoji: emojis.getComponent('currencyOption') }
];
...
async function getLtcPrice(currency = 'usd') {
    const priceCache = require('../core/priceCache');
    return priceCache.getPrice(currency);
}
